...
import com.think360.sosimply.BR;
import com.think360.sosimply.R;
import com.think360.sosimply.adapter.RecyclerBindingAdapter;
...
public class ChooserDialogFragment extends DialogFragment implements View.OnClickListener, RecyclerBindingAdapter.OnItemClickListener {
    ...
    public void onViewCreated(View dialog, @Nullable Bundle savedInstanceState) {
        ...
        if (arrayList.get(0) instanceof Datum) {
            recyclerBindingAdapter = new RecyclerBindingAdapter<>(R.layout.single_item_trip, BR.category, arrayList);
        }

        recyclerView.setAdapter(recyclerBindingAdapter);
        recyclerBindingAdapter.setOnItemClickListener(ChooserDialogFragment.this);
